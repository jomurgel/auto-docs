...
My preferred coding standards for styles, CSS, and SCSS. Coming soon. We gotta think about this one...or start a fight online. A few helpful resources
in the mean time...

## Sanitize
I've built my own SCSS-based sanitization file [here](https://gist.github.com/jomurgel/88084c6f3c10de5e47a9238087508e63)
which does a minimal amount of work to reset the browser.

You can also check out the [acorn.css](https://github.com/jomurgel/acorn.css) as well which gives you
a barebones, but functional, place to start with styles.
